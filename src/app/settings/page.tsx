    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <Section title="Email (SMTP)">
        <label style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, cursor: "pointer" }}>
          ...
          <span style={{ fontSize: 14 }}>Enable email digests</span>
        </label>
        ...
        <Field label="Password (App Password)"><input type="password" value={config.smtp.pass} onChange={(e) => setConfig({ ...config, smtp: { ...config.smtp, pass: e.target.value } })} style={inputStyle} /></Field>
        ...
        <button onClick={testEmail} disabled={testing || !config.smtp.enabled} style={{ ...secondaryBtn, marginTop: 4, opacity: config.smtp.enabled ? 1 : 0.5 }}>
